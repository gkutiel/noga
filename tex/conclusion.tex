...
\begin{enumerate}
    ...
    \item \textbf{Meteorological features and the operator forecast are the most
          informative inputs.}  Removing weather data or the operator's
          day-ahead forecast led to the largest performance degradation in the
          ablation study.
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Daily granularity.}  Our dataset and models operate at daily
          resolution.  In practice, markets clear at sub-hourly intervals and the
          asymmetry of costs may vary significantly across hours of the day.
...
\begin{enumerate}
    ...
    \item \textbf{Higher temporal resolution.}  Extending the methodology to
          hourly or sub-hourly resolution would require modelling intra-day
          demand patterns, potentially using Transformer
