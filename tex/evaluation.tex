...
Figure~\ref{fig:loss_fns} illustrates the three cost functions used for
evaluation.
The Pinball~5:1 and Pinball~20:1 functions penalise under-predictions more
heavily than over-predictions, reflecting the real-world asymmetry of
electricity procurement costs, while L1 serves as a symmetric reference point.
