The objective of this study was to determine whether a demand forecaster trained
...
IMS --- at three meteorological stations) and
...
optimiser~\parencite{kingma2014adam} at a learning rate $2\times10^{-4}$, batch
...
Using the architecture and training loop above, we compared three training
...
evaluated \emph{post-hoc calibrated} variants of all three models
...
Models were evaluated on three cost functions that reflect different assumptions
