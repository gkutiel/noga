...
\author{Gilad Kutiel \quad Or Aleksandrowicz \quad Avigdor Gal  \\[0.6em]
\normalsize Technion --- Israel Institute of Technology \\[0.3em]
\footnotesize\ttfamily gilad.kutiel@gmail.com \quad oraleks@technion.ac.il \quad avigal@technion.ac.il}
\date{March 2026}
...
from three major cities, we evaluate our approach against MSE-trained baseline models.  We then generate synthetic asymmetric cost functions
to assess performance across a range of cost scenarios.  Our results
...
\noindent\textbf{Keywords:} electricity demand forecasting; asymmetric loss functions; cost-sensitive learning; newsvendor model; pinball loss; day-ahead markets
...
\section*{Funding}
This work was funded by Israel's Ministry of Energy and Infrastructure, grant number 223-11-056.
