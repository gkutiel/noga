...
the setting of the \emph{newsvendor model}~\parencite{arrow1951optimal}, a classical
...
operator, we evaluated our models against \emph{synthetic} cost functions that
satisfy the qualitative properties stated in the problem formulation.
For simplicity, we conducted our main evaluation using two \emph{pinball loss}
...
five to twenty~\parencite{weron2014electricity}.  Pinball losses are piecewise linear
