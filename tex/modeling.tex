...
For completeness, Appendix~\ref{app:nonlinear} reports additional results under
non-linear cost functions, showing that the qualitative conclusions hold beyond
the linear regime.
