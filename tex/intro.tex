...
actually deploys, leaving open the question of whether cost-aware training improves upon a strong,
real-world operational forecast.

\subsection{Contributions}

Our work is designed to overcome both gaps currently existing in the literature described above.  We formulate the forecasting problem
...
currently used to help run a national grid.  The contributions of this paper are thus as follows:
